...
<div class="flex justify-center">
    <button type="button" class="all-fair-jobs bg-secondary text-white text-xl md:text-3xl px-8 py-3 rounded-lg"><?= __('All Fair Jobs', 'reichman') ?></button>
</div>
<div class="search-box relative px-8">
    <label for="employer-search" class="block text-primary font-bold md:text-3xl mt-3 md:mt-28"><?= __('Search By Employer', 'reichman') ?></label>
    ...
    <button type="button" class="block md:inline w-full md:w-auto search-btn bg-primary text-white border border-primary rounded-lg mt-5 md:mt-3 text-2xl py-2 px-6"><?= __('Search', 'reichman') ?></button>
</div>